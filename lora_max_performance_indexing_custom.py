...
Examples:
    python lora_max_performance_indexing_custom.py loras/v11-20250620-105815/checkpoint-1095 pictures v11_all_index_1095 indexes

""")
        sys.exit(0)
    
    # Get parameters with defaults for the specific use case
    checkpoint_path = sys.argv[1] if len(sys.argv) > 1 else "loras/v11-20250620-105815/checkpoint-1095"
    image_directory = sys.argv[2] if len(sys.argv) > 2 else "pictures"
    index_name = sys.argv[3] if len(sys.argv) > 3 else "v11_all_index_1095"
